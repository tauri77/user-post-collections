...
function mg_upc_clear_blog() {
	...
	$options = array(
		...
		'mg_upc_list_per_page',
		'mg_upc_post_stats',
		'mg_upc_share_buttons',
		'mg_upc_share_buttons_client',
		'mg_upc_ajax_load',
		'mg_upc_archive_enable',
		'mg_upc_archive_filter_type',
		'mg_upc_archive_filter_author',
		'mg_upc_archive_item_per_page',
		'mg_upc_archive_item_template',
		'mg_upc_archive_item_template_thumbs_xxl',
		'mg_upc_archive_item_template_thumbs_xl',
		'mg_upc_archive_item_template_thumbs_lg',
		'mg_upc_archive_item_template_thumbs_md',
		'mg_upc_archive_item_template_thumbs_sm',
		'mg_upc_archive_item_template_thumbs_xs',
		'mg_upc_archive_item_template_cols_xxl',
		'mg_upc_archive_item_template_cols_xl',
		'mg_upc_archive_item_template_cols_lg',
		'mg_upc_archive_item_template_cols_md',
		'mg_upc_archive_item_template_cols_sm',
		'mg_upc_archive_item_template_cols_xs',
		'mg_upc_archive_item_template_meta',
		'mg_upc_archive_item_template_user',
		'mg_upc_archive_item_template_desc',
		'mg_upc_archive_title',
		'mg_upc_archive_title_type',
		'mg_upc_archive_title_author',
		'mg_upc_archive_title_author_type',
		'mg_upc_archive_document_title',
	);
